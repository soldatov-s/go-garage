...
type MigrateConfig struct {
	...
	Action string `envconfig:"default=nothing"`
	// Count of applied/rollbacked migration
	Count int64 `envconfig:"default=0"`
