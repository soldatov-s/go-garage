...
func Registrate(ctx context.Context) context.Context {
	return providers.RegistrateByName(ctx, ProvidersName, NewHTTPServers(ctx))
}

func Get(ctx context.Context) *HTTPServers {
	v := providers.GetByName(ctx, ProvidersName)
	if v != nil {
		return providers.GetByName(ctx, ProvidersName).(*HTTPServers)
	}
	return nil
}
...
func RegistrateProvider(ctx context.Context, name string, p Provider) (context.Context, error) {
	...
	v := Get(ctx)
	if v == nil {
		return nil, ErrEmptyHTTPServers
	}
