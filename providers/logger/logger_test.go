...
func TestLoggerInitialization(t *testing.T) {
	logger := &Logger{}
	logger.Initialize(&Config{Level: LoggerLevelInfo, NoColoredOutput: true, WithTrace: false})
...
func testLoggerInitializationWithSettedLoggingLevel(t *testing.T, level string) *zerolog.Logger {
	logger := &Logger{}
	logger.Initialize(&Config{Level: level, NoColoredOutput: true, WithTrace: false})
	require.True(t, logger.IsInitialized())
